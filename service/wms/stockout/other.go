...
func (o *other) QueryWithDetail(ctx context.Context, req *OtherQueryReq, options ...core.ReqOptionFunc) (*OtherQueryResp, error) {
	apiReq := &core.ApiReq{
		HttpMethod: http.MethodPost,
		Method:     "wms.stockout.OtherQuery.queryWithDetail",
		Body:       []any{req},
	}
	return core.Retry[OtherQueryResp](ctx, o.config, func() (*core.ApiResp, error) {
