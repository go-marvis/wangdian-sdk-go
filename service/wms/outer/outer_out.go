...
func (o *outerOut) QueryWithDetail(ctx context.Context, req *QueryOuterOutReq, options ...core.ReqOptionFunc) (*QueryOuterOutResp, error) {
	apiReq := &core.ApiReq{
		HttpMethod: http.MethodPost,
		Method:     "wms.outer.OuterOut.queryWithDetail",
		Body:       []any{req},
	}
	return core.Retry[QueryOuterOutResp](ctx, o.config, func() (*core.ApiResp, error) {
