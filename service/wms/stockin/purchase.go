...
func (p *purchase) QueryWithDetail(ctx context.Context, req *PurchaseQueryReq, options ...core.ReqOptionFunc) (*PurchaseQueryResp, error) {
	apiReq := &core.ApiReq{
		HttpMethod: http.MethodPost,
		Method:     "wms.stockin.Purchase.queryWithDetail",
		Body:       []any{req},
	}
	return core.Retry[PurchaseQueryResp](ctx, p.config, func() (*core.ApiResp, error) {
		return core.Request(ctx, apiReq, p.config, options...)
	})
}
